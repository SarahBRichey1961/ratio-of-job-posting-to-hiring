...
const FALLBACK_BOARDS: ComparisonRow[] = [
  ...
  // General (12 boards)
  { id: 16, name: 'Indeed', url: 'https://indeed.com', industry: 'General', score: 78, grade: 'B', avgLifespan: 16, repostRate: 10.2, totalPostings: 7200, topRole: 'Manager', trend: 'stable', trendValue: 0.5, dataQuality: 85, affiliateUrl: 'https://indeed.com', roles: ['Developer', 'Software Engineer', 'Designer', 'Manager', 'Sales'] },
