...
import { ComparisonBarChart, BoardScoresChart } from '@/components/Charts'
...
export default function ComparisonPage() {
  ...
  // Chart data
  const topBoardsForChart = filtered.slice(0, 6).map((b) => ({
    name: b.name.replace(' ', '\n'),
    score: b.score,
    lifespan: b.avgLifespan,
    quality: b.dataQuality,
  }))

  const scoreChartData = filtered.map((b) => ({
    name: b.name,
    score: b.score,
    grade: b.grade,
  }))
  ...
  return (
    <DashboardLayout>
      ...
      {/* Comparison Table */}
      <Section title="Detailed Comparison Table">
        <Card>
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-center">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <span className="text-gray-300 text-sm">{board.dataQuality}%</span>
                      </div>
                    </td>

                    {/* Grade */}
                    <td className={`py-4 px-4 text-center font-semibold ${gradeColor(board.grade)}`}>
                      {board.grade}
                    </td>
      ...
      <Section title="Comparison Summary">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <p className="text-gray-500 text-sm mt-1">Across filtered boards</p>
          </Card>
        </div>
      </Section>
    </DashboardLayout>
