...
const ALL_BOARDS = [
  ...
  { name: 'AngelList', scraper: getEstimatedMetrics('AngelList') },
  { name: 'Built In', scraper: getEstimatedMetrics('Built In') },
  { name: 'Remote Tech Jobs', scraper: getEstimatedMetrics('Remote Tech Jobs') },
  { name: 'FlexJobs', scraper: getEstimatedMetrics('FlexJobs') },
  { name: 'We Work Remotely', scraper: getEstimatedMetrics('We Work Remotely') },
  { name: 'ZipRecruiter', scraper: getEstimatedMetrics('ZipRecruiter') },
  { name: 'Dice', scraper: getEstimatedMetrics('Dice') },
  { name: 'WellFound', scraper: getEstimatedMetrics('WellFound') },
  ...
  { name: 'The Muse', scraper: getEstimatedMetrics('The Muse') },
